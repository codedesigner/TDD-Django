...
class PollsTest(LiveServerTestCase):
    ...
    def test_can_create_new_poll_via_admin_site(self):
        ...
        username_field.send_keys('prasanna')
        ...
        # She now sees a couple of hyperlinks that says "Polls"
    ...
    def _setup_polls_via_admin(self):
        # Gertrude logs iin to the admin site
        self.browser.get(self.live_server_url + '/admin/')
        username_field = self.browser.find_element_by_name('username')
        username_field.send_keys('prasanna')
        password_field = self.browser.find_element_by_name('password')
        ...
        for poll_info in [POLL1, POLL2]:
            # Follow the link to the Polls app, and adds new Poll
            ...
            # Is returned to the "Polls" listening, where she can see her
        ...
        # She loghs out of the admin site
        self.browser.find_element_by_link_text('Log out').click()

    def test_voting_0n_a_new_poll(self):
        # First, Gertrude the administrator logs in to the admin site and
        ...
        # 'How awesome is Test-Driven Development?'
        frist_poll_title = POLL1.question
        ...
        # "no-one has voted on this pole yet."
